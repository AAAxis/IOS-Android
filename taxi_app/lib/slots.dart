...
class _SchedulePageState extends State<SchedulePage> {
  ...
  String _selectedProvider = 'Japanika'; // Default provider selection
  ...
  final List<String> _providers = ['Japanika', 'Yango Deli', 'Ten Bis'];
  ...
  void _showAddScheduleDialog(BuildContext context) {
    ...
    String selectedProvider = _providers[0]; // Default to the first provider
                      ...
                      return Dismissible(
                        ...
                        child: Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text(
                              'Slot at ${data['provider']}',
                              style: TextStyle(fontSize: 12, color: Colors.black), // Make it black
                            ),
                          ),
                        ),
                      );
