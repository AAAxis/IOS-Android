...
import 'package:taxi_app/mainScreens/success_page.dart';
...
class _MapScreenState extends State<MapScreen> {
  ...
  int getCarPrice(String carType) {
    if (carType == 'Regular') {
      ...
      return (distanceInMeters / 1000 * 2.0 + 200).toInt();
              ...
              child: IconButton(
                ...
                onPressed: () async {
                  ...
                  if (email != null && email.isNotEmpty) {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (c) => MyDrawerPage()));
                  } else {
                            ...
                            children: [
                              Container(
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    setSelectedCarType('Van');
                                  },
                                  color: selectedCarType == 'Van'
                                      ? Colors.black
                                      : Colors.grey,
                                ),
                              ),
                              Text('Van'),
                              Text('\$${getCarPrice('Van')}'),
                            ],
                          ),
                        ),
